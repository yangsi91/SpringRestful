...
public class LabelApp {
  ...
  private static final int MAX_LABELS = 1;
...
//    printLabels(System.out, imagePath, app.labelImage(imagePath, MAX_LABELS));
    return printLabels(System.out, imagePath, app.labelImage(imagePath, MAX_LABELS));
  }

  /**
   * Prints the labels received from the Vision API.
   */
  public static String printLabels(PrintStream out, Path imagePath, List<EntityAnnotation> labels) {
    String s = null;
